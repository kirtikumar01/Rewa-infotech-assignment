...
const Register = () => {
    ...
    useEffect(()=>{
        document.title = "Insanely Gaming | Register"
      },[])
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={submitHandler} className="space-y-4 md:space-y-6">
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Already have an account yet? <Link href="/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign in</Link>
                            </p>
                        </form>
                    </div>
                </div>
